...
EXPERIMENT = f'train_resnet-Resnet18_base5_kuangliu_noSched-linearLR' # https://github.com/kuangliu/pytorch-cifar
...
scheduler = torch.optim.lr_scheduler.LinearLR(optimizer, start_factor=1, end_factor=0.001, total_iters=config.EPOCHS)
